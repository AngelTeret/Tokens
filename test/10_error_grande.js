// Error: Múltiples errores complejos
class GestorTareas {
    constructor() {
        this.tareas = [];
...
// Error: sintaxis incorrecta en uso
const gestor = new GestorTareas();

// Error: llamada de función mal formada
...
// Error: sintaxis incorrecta en console.log
console.log(utilidades.generarReporte(gestor));

// Error: filtro mal formado
